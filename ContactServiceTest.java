...
public class ContactServiceTest {
    ...
    @BeforeEach
    void setUp() {
        contactId = "091as34lhj";
        firstNameTest = "Sponge Boi";
        lastNameTest = "ME bob";
        phoneNumberTest = "5555555555";
        addressTest = "123 north jersey st. St. Louis, MO";
        tooLongContactId = "657349375648920934765784";
        tooLongFirstName = "Smitty warber jagermen jenson";
        tooLongLastName = "jeckle hidy widdie tighddy";
        tooLongPhoneNumber = "555555555555";
        tooShortPhoneNumber = "5555555";
        tooLongAddress = "`134575699 Jiggly giggly giggity giggity striggily diggily street";
    }

    /*
    Below is the code for the program to carry out the needed functions to test the first and last name
    phone number, address, and the contact class/ constructor as a whole.
     */
